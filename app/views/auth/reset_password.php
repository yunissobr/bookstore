                    ...
                    <div class="row m-0">
                      <div class="col-sm-12 sign-in-page-data">
                          <div class="sign-in-from bg-primary rounded">
                                <h3 class="mb-0 text-white">إعادة تعيين كلمة المرور</h3>
                                <p class="text-white">أدخل عنوان بريدك الإلكتروني وسنرسل إليك بريدًا إلكترونيًا يحتوي على تعليمات لإعادة تعيين كلمة مرورك.</p>
                                <?php show_alert() ?>
                                <form method="post" class="mt-4 form-text">
                                    <div class="form-group">
                                        <label for="email">بريدك الالكتروني</label>
                                        <input type="email" class="form-control mb-0" name="email" id="email" placeholder="أدخل البريد الإلكتروني" required>
                                    </div>
                                    <div class="d-inline-block w-100">
                                        <button type="submit" class="btn btn-white" name="send">إرسال</button>
                                    </div>
                                </form>
                          </div>
                        </div>
