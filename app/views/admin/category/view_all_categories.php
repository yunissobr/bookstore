                     ...
                     <div class="iq-card">
                        <div class="iq-card-header d-flex justify-content-between">
                           <div class="iq-header-title">
                              <h4 class="card-title">لائحة التصنيفات</h4>
                              
                           </div>
                           <?php @show_alert(false)?>
                           <div class="iq-card-header-toolbar d-flex align-items-center">
                              <a href="<?=URLROOT?>admin/category" class="btn btn-primary">تصنيف جديد</a>
                           </div>
                        </div>
                              ...
                              <table class="data-tables table table-striped table-bordered" style="width:100%">
                                ...
                                <tbody>
                                    <?php foreach ($data['categories'] as $category): ?>
                                        <tr>
                                             <td>
                                               <img src="<?=URLROOT.'img/category/'.$category->image?>" class="img-fluid avatar-50 rounded" alt="<?=$category->name?>">
                                            </td>
                                            <td><?=$category->name?></td>
                                            <td>
                                            ...
                                            <td>
                                               <div class="flex align-items-center list-user-action">
                                                 <a class="bg-primary" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit" href="<?=URLROOT.'admin/category/'.$category->id?>"><i class="ri-pencil-line"></i>
                                                 </a>
                                                 <a class="bg-danger" data-toggle="tooltip" data-placement="top" title="" data-original-title="حذف" href="#"><i class="ri-delete-bin-line" data-toggle="modal" data-target="#delete<?=$category->id?>"></i></a>
                                              </div>
                                            </td>
                                        </tr>
                                    <?php endforeach ?>     
              ...
              <div class="modal-content">
                 ...
                 <div class="modal-footer">
                    ...
                    <form method="post">
                        ...
                        <button type="submit" class="btn btn-danger" name="delete_category">حذف</button>
                    </form>
