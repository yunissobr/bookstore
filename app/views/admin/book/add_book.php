...
<html lang="ar" dir="rtl">
   <head>
      ...
      <title><?=SITENAME?> - Books - Add New</title>
      <!-- Favicon -->
                     ...
                     <div class="iq-card">
                        <div class="iq-card-header d-flex justify-content-between">
                           <div class="iq-header-title">
                              <h4 class="card-title">أضف كتاب</h4>
                           </div>
                        </div>
                           ...
                           <form method="post" enctype="multipart/form-data">
                              ...
                              <div class="form-group">
                                 ...
                                 <div class="custom-file">
                                    <input type="file" class="custom-file-input" accept="image/png, image/jpeg" name="book_image" required>
                              ...
                              <div class="form-group">
                                 <label> كتاب:</label>
                                 <div class="custom-file">
                                    <input type="file" class="custom-file-input" name="book_file" required>
                                    <label class="custom-file-label">اختر ملف</label>
                                 </div>
                              </div>
                              <div class="form-group">
                              ...
                              <button type="submit" name="add_book" class="btn btn-primary" >إرسال</button>
