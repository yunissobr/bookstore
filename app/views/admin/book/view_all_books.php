                     ...
                     <div class="iq-card">
                        <div class="iq-card-header d-flex justify-content-between">
                           ...
                           <div class="iq-card-header-toolbar d-flex align-items-center">
                              <a href="<?=URLROOT?>admin/book" class="btn btn-primary">كتاب جديد</a>
                           </div>
                        </div>
                                ...
                                <tbody>
                                    <?php foreach ($data['books'] as $book): ?>
                                       ...
                                       ?>
                                        <tr>
                                             <td>
                                               <img src="<?=URLROOT.'img/book/'.$book->image?>" class="img-fluid avatar-50 rounded" alt="<?=$book->name?>">
                                            </td>
                                            <td><?=$book->name?></td>
                                            <td><?=$category->name?></td>
                                            ...
                                            <td><?=$book->price?></td>
                                            <td><a href="<?=URLROOT.'books/'.$book->book_file?>" target="_blank"><i class="ri-file-fill text-secondary font-size-18"></i></a></td> 
                                            </td>
                                            <td>
                                               <div class="flex align-items-center list-user-action">
                                                 <a class="bg-primary" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit" href="<?=URLROOT.'admin/book/'.$book->id?>"><i class="ri-pencil-line"></i>
                                                 </a>
                                                 <a class="bg-danger" data-toggle="tooltip" data-placement="top" title="" data-original-title="حذف" href="#"><i class="ri-delete-bin-line" data-toggle="modal" data-target="#delete<?=$book->id?>"></i></a>
                                              </div>
                                            </td>
                                        </tr>
                                    <?php endforeach ?>     
              ...
              <div class="modal-content">
                 ...
                 <div class="modal-footer">
                    ...
                    <form method="post">
                        ...
                        <button type="submit" class="btn btn-danger" name="delete_book">حذف</button>
                    </form>
