...
<html lang="ar" dir="rtl">
   <head>
      ...
      <title><?=SITENAME?> - Authors - Add New</title>
      <!-- Favicon -->
                     ...
                     <div class="iq-card">
                        <div class="iq-card-header d-flex justify-content-between">
                           <div class="iq-header-title">
                              <h4 class="card-title">أضف مؤلف</h4>
                           </div>
                        </div>
                           ...
                           <form method="post" enctype="multipart/form-data">
                              ...
                              <div class="form-group">
                                 ...
                                 <div class="custom-file">
                                    <input type="file" class="custom-file-input" accept="image/png, image/jpeg" name="author_image" required>
                              ...
                              <button type="submit" name="add_author" class="btn btn-primary" >إرسال</button>
