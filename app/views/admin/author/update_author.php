...
<html lang="ar" dir="rtl">
   <head>
      ...
      <title><?=SITENAME?> - Author - Update</title>
      <!-- Favicon -->
                     ...
                     <div class="iq-card">
                        <div class="iq-card-header d-flex justify-content-between">
                           <div class="iq-header-title">
                              <h4 class="card-title">تحديث المؤلف</h4>
                           </div>
                        </div>
                        ...
                        <div class="iq-card-body">
                           <form method="post" enctype="multipart/form-data">
                              <div class="form-group">
                                 ...
                                 <input type="text" class="form-control" name="name" value="<?=$data['author']->fullname ?>" required>
                              </div>
                              <div class="form-group">
                                 <label>صورة المؤلف:</label>
                                 <img class="img-thumbnail mb-2" width="20%" src="<?=URLROOT.'img/author/'.$data['author']->image?>" alt="" srcset="">
                                 <div class="custom-file">
                                    <input type="file" class="custom-file-input" accept="image/png, image/jpeg" name="author_image" >
                              ...
                              <div class="form-group">
                                 ...
                                 value="<?php echo ($data['author']->email != '_') ? $data['author']->email : '' ?>" disabled required>
                              </div>
                              <div class="form-group">
                                 <label>وصف:</label>
                                 <textarea class="form-control" rows="4" name="description" required><?=$data['author']->description ?></textarea>
                              </div>
                              
                              <button type="submit" name="update_author" class="btn btn-primary" >تحديث</button>
